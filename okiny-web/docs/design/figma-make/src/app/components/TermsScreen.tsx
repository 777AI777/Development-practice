    ...
    <>
      ...
      <div className="mt-8 space-y-8 text-sm leading-relaxed text-foreground">
        ...
        <section>
          ...
          <p className="mt-2 text-foreground/80">
            本サービスは、ユーザーが自身の「好き」を投稿形式で整理・共有できるプラットフォームです。映画、音楽、カフェなど、あらゆるジャンルのマイ投稿を作成・管理できます。
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2 text-foreground/80">
            ユーザーが本サービスに投稿したコンテンツ（投稿、テーマ、タグ等）について、ユーザーは運営者に対し、本サービスの運営・改善・宣伝に必要な範囲で、無償・非独占的に使用（複製、表示、配信を含む）する権利を許諾するものとします。
          </p>
          <p className="mt-2 text-foreground/80">
