        ...
        <div className="mt-6 space-y-3">
          {MOCK_USERS.map((mockUser) => (
            <button
              ...
              className="flex w-full items-center gap-3 rounded-lg border border-border bg-card px-4 py-3 text-left text-sm font-semibold text-foreground transition hover:bg-muted"
            >
              <svg
              ...
              <span className="flex-1">Googleでログイン（{mockUser.name}）</span>
